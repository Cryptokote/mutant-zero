const projects = [
{name: "DEFENSES",
description: "Palisades, earthworks or even a moat. Protects the Ark against enemies on the outside, and makes it harder to slip in or out unnoticed.",
dev_req: null,
skills: ["Force", "Scout"],
work_points: 8,
dev_bonus: {warfare: 2}},
...
{name: "CROPLAND",
description: "A plot of land is set aside for the organized cultivation of grain, corn, turnips, radishes, or even mushrooms. Simple tools like plows and harrows are made and utilized.",
dev_req: null,
...
{name: "SLAVE MARKET",
description: "The Bosses of the Ark start trading in slaves, taken from the People or other groups in the Zone. They trade with each other or with traveling slavers.",
dev_req: null,
skills: ["Fight", "Manipulate"],
work_points: 8,
...
{name: "PIGSTY",
description: "Pigs and other farm animals from the Old Age roam free after the Apocalypse and have turned into wild and often heavily mutated creatures. Yet, they can be caught and brought into the service of the People.",
dev_req: null,
skills: ["Endure", "Know the Zone"],
work_points: 8,
dev_bonus: {food_supply: 2}},
...
{name: "TEMPLE",
description: "A shrine where the People can worship the Ancients in the Sky, the Firstborn Mutant or why not even the Rot itself.",
dev_req: null,
...
{name: "ZONE WRESTLING",
description: "A metal cage where the strongest mutants fight each other for bullets and glory. Less physically inclined mutants bet on the outcome. No weapons are allowed in the cage, but mutations are considered fair play.",
dev_req: null,
skills: ["Fight", "Manipulate"],
work_points: 4,
dev_bonus: {warfare: 1}},
...
description: "An expedition into the Zone is a special type of project, described in detail in Chapter 8. It requires no work_points and can be undertaken several times over. Only one Zone Expedition can be launched per Assembly. The PCs can decide whether to join the expedition or not.",
dev_req: null,
skills: null,
work_points: null,
dev_bonus: 'variable'},
...
{name: "SUNDIAL",
description: "A device consisting of a stick placed on a flat disc of some kind, letting the People tell time by watching the shadow of the stick move.",
dev_req: {culture: 5},
skills: ["Comprehend"],
work_points: 4,
...
{name: "STABLES",
description: "Bitterbeasts (page 178) and other animals in the Zone can be caught to be used as mounts by the People – but they need to be tamed and trained first.",
...
description: "In this confined area, suspected evildoers and traitors in the Ark can be tormented until they divulge everything they know – and more.",
...
{name: "TRIBUNAL",
description: "A court given the power to mete out punishment on mutants who steal, murder or disrupt the order of things. Corporal punishment is the norm, as the Ark can hardly afford to keep people locked up for very long. Hard labor or even exile are also possible penalties.",
dev_req: {warfare: 10, culture: 10},
...
{name: "CALENDAR",
description: "Using a few simple astronomical observations (when the Zone smog lifts enough to let the People see the stars), the People manage to recreate a yearly calendar of 365 days.",
...
{name: "INK",
description: "& PAPER The People have discovered a method of turning tattered paper from the Old Age, or plants growing in the Zone, to paper – and can create simple inks to write with.",
dev_req: {technology: 15, culture: 10},
skills: ["Comprehend"],
work_points: 8,
dev_bonus: {culture: 2},
...
{name: "DISTILLERY",
description: "This contraption of tanks, bottles and tubes can be used to extract a great number of chemical substances from burning wood or plants. One of its many uses is to brew booze (page 93).",
...
{name: "SHIP",
description: "A ship built of scrap, bigger than anything a single Gearhead could construct on his own. It could be steam-powered if the People have completed the Steam Engine project (page 111). If not, it is fitted with sails or oars.",
dev_req: {technology: 20},
other_req: "Harbor",
skills: ["Endure", "Comprehend"],
work_points: 12,
dev_bonus: {food_supply: 1, culture: 1, warfare: 1},
special: "The Ship can carry about 50 passengers and can used to explore coastal sectors of the Zone. The time required is halved compared to exploring on foot (page 122). The ship can also be used to escape from threats at sea, and gives Gear Bonus 1 in such situations. Armor: 3. Resilience: 20"},
...
{name: "SHELTER",
description: "Hidden tunnels and escape routes dug underneath the Ark. Here, you can seek shelter or make your getaway if the Ark is invaded.",
...
{name: "SETTLEMENT",
description: "The People find a new spot to live and establish a new settlement in a different sector. When the settlement is complete, decide how many of the Ark’s inhabitants move there.",
dev_req: {warfare: 20, culture: 20}, 
other_req: "The new settlement must be located in a sector explored by the PCs or a Zone Expedition (Chapter 8), and at least 2D6 sectors away from the Ark.",
skills: ["Endure"],
work_points: 12,
dev_bonus: null,
special: "The new settlement will have its own DEV ratings, and will start at zero in all of them. New projects are undertaken in the new settlement, separately from the Ark. Some projects, such as the Road, Heliograph and Railroad, connect two settlements. They give their DEV bonus to both settlements when complete"},

{name: "ROAD",
description: "Transforms one of the paths in the Zone into a road, which can be used by carriages or motor-driven vehicles. This project can be undertaken many times over – every sector to be traversed by a Road counts as a separate project.",
dev_req: {technology: 20},
skills: ["Endure", "Comprehend"],
work_points: "1 × number of PCs per sector",
dev_bonus: {food_supply: 1, culture: 1},
dev_bonus_special: "– but only when the Road reaches another settlement in the Zone. The DEV bonuses are for the entire Road, not for every sector",
...
work_points: 4,
dev_bonus: {warfare: 1},
special: "Combined with the Foundry, the Explosives Lab can be used to manufacture bullets. Bullets are then bartered in the Ark at half the normal cost"},
...
work_points: 12,
dev_bonus: null,
special: "A Train can carry around ten passengers, increases the speed of movement in combat and cuts the time it takes to explore a sector in the Zone by half. How vehicles work is explained in Chapter 6. The Steam Car be used to escape from threats or to ram enemies. Gear Bonus: 1. Armor: 3. Resilience: 3"},

{name: "RAILROAD",
description: "To build a rail link through the Zone is an advanced and very demanding project. Every sector to be traversed by railroad counts as its own project.",
...
dev_bonus_special: "but only when the Train runs on a rail track that reaches another settlement in the Zone. The DEV bonuses are for the entire railway, not for every sector",
special: "A Train can carry around 50 passengers and will cross a sector in the Zone in mere minutes – as long as nothing blocks the tracks. The Train can also be used to escape from threats or to ram enemies. Gear Bonus: 1. Armor: 3. Resilience: 15"},

{name: "ARSENAL",
description: "In this specialized workshop, the People can massproduce breech-loaded firearms. An Arsenal is often combined with an Explosives Lab (above).",
...
{name: "SURGERY",
description: "The bonesaws of the Ark have learned the anatomy of the mutant body, as well as the use of ether or other forms of anesthesia, and can perform simple surgical operations.",
dev_req: {technology: 35},
other_req: "Distillery",
skills: ["Comprehend"],
work_points: 8,
dev_bonus: null,
special: "Any rolls to Heal a critical injury at the surgical clinic get a +two modification. The Session Body Count (below) is reduced by one"},
